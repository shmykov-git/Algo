    ...
    static class Scene3
    {
        public static Shape GetShape(Settings settings)
        {
            ...
            var shapes = new Shape[]
            {
                ...
                d.Mult(0.8).Move(1.3,-0.8,0.2).ToLines3(0.5, Color.Gold),
                d.Mult(0.8).Move(1.3,-0.8,-0.2).ToLines3(0.5, Color.Gold),
                d.Move(1,-0.7,0).ToLines3(0.5, Color.Gold),
                Vectorizer.GetContentShape(settings.GetContentFileName("m7.jpg")).ToLines3(1, Color.Blue),
