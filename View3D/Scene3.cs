    ...
    static class Scene3
    {
        public static Shape GetShape(Settings settings)
        {
            ...
            var shapes = new Shape[]
            {
                ...
                Shapes.GolfBall.Mult(2).ToLines3(1, Color.White).ApplyColorGradient(new Vector3(-2.2,-1.75,0).Normalize(), Color.Blue, Color.Blue, null, null, null, null, null, null, null, Color.Blue, Color.Blue).Move(-2.2,-1.75,0),
                Vectorizer.GetContentShape(settings.GetContentFileName("t6.jpg"), 230).ToLines3(2, Color.Blue),//.ApplyColorSphereGradient(null, null, null, null, Color.Red),
