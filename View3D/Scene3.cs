    ...
    static class Scene3
    {
        public static Shape GetShape(Settings settings)
        {
            ...
            var shapes = new Shape[]
            {
                ...
                Vectorizer.GetContentShape(settings.GetContentFileName("lh1.jpg"), 100).ApplyZ(Funcs3Z.Waves).ToLines3(1, Color.White).ApplyColorGradient(new Vector3(1,1.8,0).Normalize(), null, null, null, null,  Color.Blue, Color.Blue), // .ApplyZ(Funcs3Z.SphereMR(1.2)).Move(-0.7,-0.7,0.5)
