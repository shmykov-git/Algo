    ...
    static class Scene3
    {
        public static Shape GetShape(Settings settings)
        {
            ...
            var shapes = new Shape[]
            {
                ...
                Shapes.IcosahedronSp1.Mult(3).Move(3, 1, 0).ToMetaShape3(3, 3, Color.Gold, Color.Gold).ApplyColorGradient(new Vector3(8,1,0).Normalize(), null, null, null, Color.Blue, Color.Blue, Color.Blue, Color.Blue, Color.Blue, Color.Blue), // .ApplyZ(Funcs3Z.SphereMR(1.2)).Move(-0.7,-0.7,0.5),
                ...
                Vectorizer.GetContentShape(settings.GetContentFileName("f2.jpg"), 180).Mult(1.5).ApplyZ(Funcs3Z.Waves).ToLines3(1, Color.Gold),
