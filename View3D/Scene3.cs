    ...
    static class Scene3
    {
        public static Shape GetShape(Settings settings)
        {
            ...
            var shapes = new Shape[]
            {
                ...
                Vectorizer.GetText("hukumaru186", 100, "Times New Roman").Centered().Normed().Mult(0.2).Move(0.8,-0.6,0).ToLines3(1, Color.Blue),
                Vectorizer.GetContentShape(settings.GetContentFileName("l_po.png"),130).ApplyZ(Funcs3Z.SphereR(1.2)).Move(0,0,-1).ToLines3(1, Color.Blue),
