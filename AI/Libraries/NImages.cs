...
public static class NImages
{
    ...
    public static IEnumerable<NImageInfo> GetSmileNoiseImages(int count, int m, int n, int smileN, int shiftN, double noiseFactor, Vectorizer vectorizer, Random rnd)
    {
