...
public static class N21Graphs
{
    ...
    // 2-4-1
    public static (int i, int j)[][] Moon => [[(0, 2), (0, 3), (0, 4), (1, 3), (1, 5), (1, 4)], [(2, 6), (3, 6), (4, 6), (5, 6)]];
    ...
    // 2-7-1
    public static (int i, int j)[][] Mars => [[(0, 2), (0, 3), (0, 6), (0, 5), (0, 7), (0, 8), (1, 3), (1, 2), (1, 4), (1, 5), (1, 7), (1, 8)], [(2, 9), (3, 9), (4, 9), (5, 9), (6, 9), (7, 9), (8, 9)]];

    // 2-9-1
    public static (int i, int j)[][] Venus => [[(0, 2), (0, 3), (0, 6), (0, 5), (0, 7), (0, 9), (0, 10), (1, 3), (1, 2), (1, 4), (1, 5), (1, 7), (1, 8), (1, 9), (1, 10)], [(2, 11), (3, 11), (4, 11), (5, 11), (6, 11), (7, 11), (8, 11), (9, 11), (10, 11)]];
}
