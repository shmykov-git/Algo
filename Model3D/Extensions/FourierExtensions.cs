...
namespace Model3D.Extensions
{
    ...
    {
        public static Shape ToSingleConvexShape(this IEnumerable<Fr> frs, int count = 256, bool radiusPerfecto = false) => radiusPerfecto 
            ? frs.RadiusPerfecto().ToPolygon(count).ToSingleConvexShape() 
            : frs.ToPolygon(count).ToSingleConvexShape();
