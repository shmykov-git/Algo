...
namespace Model3D.Libraries
{
    ...
    public static class SolidFuncs
    {
        ...
        //public static SolidFunc Paraboloid => (double u, double v) => new Vector3(u, v, u * u + v * v);
        //public static SolidFunc Hyperboloid => (double u, double v) => new Vector3(u, v, u * u - v * v);
        ...
        //public static SolidFunc Torus(double a) => (double u, double v) => new Vector3(Math.Cos(u) * (a + Math.Sin(v)), Math.Sin(u) * (a + Math.Sin(v)), Math.Cos(v));
        //public static SolidFunc Cylinder => (double u, double v) => new Vector3(Math.Cos(u), Math.Sin(u), v);
        //public static SolidFunc CylinderY => (double u, double v) => new Vector3(Math.Cos(u), v, Math.Sin(u));
        //public static SolidFunc CylinderYm => (double u, double v) => new Vector3(Math.Cos(u), v, -Math.Sin(u));
        //public static SolidFunc CylinderABYm(double a, double b) => (double u, double v) => new Vector3(a * Math.Cos(u), v, -b * Math.Sin(u));
        //public static SolidFunc Circle => (double u, double v) => v * new Vector3(Math.Cos(u), Math.Sin(u), 0);
        //public static SolidFunc Cone => (double u, double v) => v * new Vector3(Math.Cos(u), Math.Sin(u), 1);
        //public static SolidFunc ConeM => (double u, double v) => v * new Vector3(Math.Cos(u), Math.Sin(u), -1);

        //public static SolidFunc Shamrock => (double u, double v) =>
        //    new Vector3(
        ...
        //public static SolidFunc Shell => (double u, double v) =>
        //    new Vector3(
        ...
        //public static SolidFunc SeeShell => (double u, double v) =>
        //    new Vector3(
        //        u * Math.Cos(u) * Math.Cos(v) * (Math.Cos(v) + 1),
        //        u * Math.Sin(u) * Math.Cos(v) * (Math.Cos(v) + 1),
        ...
        //public static SolidFunc DiniSolid => (double u, double v) =>
        //    new Vector3(
        ...
        //public static SolidFunc MobiusStrip => (double u, double v) =>
        //    new Vector3(
        ...
        //public static SolidFunc MathFlower => (double u, double v) =>
        //{
