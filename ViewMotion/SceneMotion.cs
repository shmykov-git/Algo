...
partial class SceneMotion
{
    ...
    {
        //var s = Shapes.Plane(30, 32, Convexes.ChessSquares, false, false).Scale(3, 1, 1);
        //return (s+s.PullOnSurface(SurfaceFuncs.Spiral)).ToMeta().ToMotion();
        var n = 6;
        var zK = 5;
        ...
        //return (100).Range().Select(i => Shapes.Stone(4, i, quality: 2).Perfecto(5).DebugJs().ToMeta()).ToMotion();
